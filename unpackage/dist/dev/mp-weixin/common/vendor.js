...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"程序员","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 34 */
/*!*****************************************!*\
  !*** D:/demo/SUPERY/common/loadFont.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.loadAppFont = loadAppFont;
...
var FONT_FAMILY = 'AaJiJiaHei';
exports.FONT_FAMILY = FONT_FAMILY;
var FONT_FILE = '/static/font/AaJiJiaHei-2.ttf';
var FONT_CACHE_PATH_KEY = 'font_cache_path_AaJiJiaHei';

/** 真机仅支持 HTTPS，开发环境 http 时回退到线上域名 */
function getFontHttpsUrl() {
  var host = (_config.default || '').replace(/\/$/, '');
  if (!host.startsWith('https://')) {
    host = 'http://192.168.200.1:80';
  }
  return "".concat(host).concat(FONT_FILE);
}
  ...
  return new Promise(function (resolve, reject) {
    ...
    fs.readFile({
      ...
      success: function success(res) {
        resolve("url(\"data:font/ttf;base64,".concat(res.data, "\")"));
      },
      fail: reject
    });
  });
...
function downloadAndCacheFont() {
  var url = getFontHttpsUrl();
  return new Promise(function (resolve, reject) {
    uni.downloadFile({
      url: url,
      success: function () {
        var _success = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {
          var fs, saveRes, source;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  reject(new Error("\u5B57\u4F53\u4E0B\u8F7D\u5931\u8D25: ".concat(res.statusCode)));
                  return _context.abrupt("return");
                case 3:
                  _context.prev = 3;
                  fs = wx.getFileSystemManager();
                  _context.next = 7;
                  return new Promise(function (resSave, rejSave) {
                    fs.saveFile({
                ...
                case 7:
                  ...
                  _context.next = 11;
                  return readFileAsDataUrl(saveRes.savedFilePath);
                case 11:
                  source = _context.sent;
                  _context.next = 14;
                  return loadFontFace(source);
                case 14:
                  resolve();
                  _context.next = 20;
                  break;
...
function loadAppFont() {
  var cachedPath = uni.getStorageSync(FONT_CACHE_PATH_KEY);
  if (cachedPath) {
    return readFileAsDataUrl(cachedPath).then(function (source) {
      return loadFontFace(source);
    }).catch(function () {
...
/* 38 */
/*!***************************************!*\
  !*** D:/demo/SUPERY/common/config.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 42 */
/*!****************************************!*\
  !*** D:/demo/SUPERY/common/request.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var request = {};
var headers = {};
var AUTH_KEYWORDS = ['Token', 'token', '登录', '未登录', '授权', 'expired', 'Unauthorized'];
function isAuthError(msg) {
  if (!msg) return false;
  return AUTH_KEYWORDS.some(function (k) {
...
request.globalRequest = function (url, method, data, power) {
  ...
  return new Promise(function (resolve, reject) {
    uni.request(_objectSpread(_objectSpread({}, config), {}, {
      success: function success(res) {
...
request.uploadFile = function (url, filePath, name, formData) {
  return new Promise(function (resolve, reject) {
    var header = {};
    var token = uni.getStorageSync('token');
    if (token) {
...
exports.default = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 42));
var _config = _interopRequireDefault(__webpack_require__(/*! @/common/config.js */ 38));
var api = {};
var API_HOST_V2 = _config.default + '/api/v2';
...
api.login = function (data) {
  return _request.default.globalRequest(API_HOST_V2 + '/login', 'POST', data);
};
...
api.verifyToken = function () {
  return _request.default.globalRequest(API_HOST_V2 + '/token/verify', 'POST');
};
...
api.refreshToken = function () {
  return _request.default.globalRequest(API_HOST_V2 + '/token/refresh', 'POST');
};
 ...
 */
api.logout = function () {
  return _request.default.globalRequest(API_HOST_V2 + '/logout', 'POST');
};
...
api.updateUserInfo = function (data) {
  return _request.default.globalRequest(API_HOST_V2 + '/user/info', 'PUT', data);
};
 ...
 * @description Token通过请求头 Authorization: Bearer &lt;token&gt; 传递
 */
api.uploadImage = function (filePath, formData) {
  return _request.default.uploadFile(API_HOST_V2 + '/image/upload', filePath, 'image', formData);
};
 ...
 * @description Token通过请求头 Authorization: Bearer &lt;token&gt; 传递
 */
api.getImageList = function (data) {
  return _request.default.globalRequest(API_HOST_V2 + '/image/list', 'GET', data);
};
 ...
 * @description Token通过请求头 Authorization: Bearer &lt;token&gt; 传递
 */
api.deleteImage = function (id) {
  return _request.default.globalRequest(API_HOST_V2 + '/image/' + id, 'DELETE');
};
 ...
 */
api.updateImageInfo = function (id, data) {
  return _request.default.globalRequest(API_HOST_V2 + '/image/' + id, 'PUT', data);
};
 ...
 * @description Token通过请求头Authorization: Bearer <token>传递
 */
api.saveAiImage = function (data) {
  return _request.default.globalRequest(API_HOST_V2 + '/ai/image/save', 'POST', data);
};
 ...
 * @description Token通过请求头Authorization: Bearer <token>传递
 */
api.getAiImageList = function (data) {
  return _request.default.globalRequest(API_HOST_V2 + '/ai/image/list', 'GET', data);
};
...
function downloadFile(url) {
  var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'temp';
  return new Promise(function (resolve) {
    if (url.startsWith('data:')) {
      var fs = wx.getFileSystemManager();
      var filePath = "".concat(wx.env.USER_DATA_PATH, "/").concat(prefix, "_").concat(Date.now(), ".png");
 ...
 * @returns {Promise<void>}
 */
function saveImageToAlbum(_x) {
  return _saveImageToAlbum.apply(this, arguments);
}
/**
 * 格式化文件大小
...
function _saveImageToAlbum() {
  _saveImageToAlbum = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(imageUrl) {
    var filePath;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.prev = 3;
            _context.next = 6;
            return downloadFile(imageUrl, 'save');
          case 6:
