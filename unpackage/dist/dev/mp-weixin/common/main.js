...
/* harmony import */ var _App_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=0&lang=css& */ 39);
...
var _default = {
  onLaunch: function onLaunch() {
    (0, _loadFont.loadAppFont)().then(function () {
      return console.log('字体加载成功');
    }).catch(function (err) {
      return console.error('字体加载失败', err);
    });
    uni.showShareMenu({
